...
namespace WoWClassicTalentCalculator.DataAccess.DataSeeder
{
    public static class ShamanClassSeeder
    {
        public static List<WarcraftClassSpecification> Setup(List<TalentIcon> icons)
        {
            ...
            {
                new SpecificationTalent { TalentName = "Convection", ColumnIndex = 1, RowIndex = 0, TalentIconId = icons.First(i => i.FileName == "spell_nature_wispsplode").Id,
                ...
                new SpecificationTalent { TalentName = "Concussion", ColumnIndex = 2, RowIndex = 0, TalentIconId = icons.First(i => i.FileName == "spell_fire_fireball").Id,
                    TalentRanks = new List<TalentRank> {
                ...
                new SpecificationTalent { TalentName = "Earth's Grasp", ColumnIndex = 0, RowIndex = 1, TalentIconId = icons.First(i => i.FileName == "spell_nature_stoneclawtotem").Id,
                    TalentRanks = new List<TalentRank> {
                ...
                new SpecificationTalent { TalentName = "Elemental Warding", ColumnIndex = 1, RowIndex = 1, TalentIconId = icons.First(i => i.FileName == "spell_nature_spiritarmor").Id,
                     TalentRanks = new List<TalentRank> {
                ...
                new SpecificationTalent { TalentName = "Call of Flame", ColumnIndex = 2, RowIndex = 1, TalentIconId = icons.First(i => i.FileName == "spell_fire_immolation").Id,
                    TalentRanks = new List<TalentRank> {
                ...
                new SpecificationTalent { TalentName = "Elemental Focus", ColumnIndex = 0, RowIndex = 2, TalentIconId = icons.First(i => i.FileName == "spell_shadow_manaburn").Id,
                    TalentRanks = new List<TalentRank> {
                ...
                new SpecificationTalent { TalentName = "Reverberation", ColumnIndex = 1, RowIndex = 2, TalentIconId = icons.First(i => i.FileName == "spell_frost_frostward").Id,
                    TalentRanks = new List<TalentRank> {
                ...
                new SpecificationTalent { TalentName = "Call of Thunder", ColumnIndex = 2, RowIndex = 2, TalentIconId = icons.First(i => i.FileName == "spell_nature_callstorm").Id,
                    TalentRanks = new List<TalentRank> {
                ...
                new SpecificationTalent { TalentName = "Improved Fire Totems", ColumnIndex = 0, RowIndex = 3, TalentIconId = icons.First(i => i.FileName == "spell_fire_sealoffire").Id,
                    TalentRanks = new List<TalentRank> {
                ...
                new SpecificationTalent { TalentName = "Eye of the Storm", ColumnIndex = 1, RowIndex = 3, TalentIconId = icons.First(i => i.FileName == "spell_nature_eyeofthestorm").Id,
                    TalentRanks = new List<TalentRank> {
                ...
                new SpecificationTalent { TalentName = "Elemental Devastation", ColumnIndex = 3, RowIndex = 3, TalentIconId = icons.First(i => i.FileName == "spell_fire_elementaldevastation").Id,
                    TalentRanks = new List<TalentRank> {
                ...
                new SpecificationTalent { TalentName = "Storm Reach", ColumnIndex = 0, RowIndex = 4, TalentIconId = icons.First(i => i.FileName == "spell_nature_stormreach").Id,
                    TalentRanks = new List<TalentRank> {
                ...
                new SpecificationTalent { TalentName = "Elemental Fury", ColumnIndex = 1, RowIndex = 4, TalentIconId = icons.First(i => i.FileName == "spell_fire_volcano").Id,
                    TalentRanks = new List<TalentRank> {
                ...
                new SpecificationTalent { TalentName = "Lightning Mastery", ColumnIndex = 2, RowIndex = 5, TalentIconId = icons.First(i => i.FileName == "spell_lightning_lightningbolt01").Id,
                    TalentRanks = new List<TalentRank> {
                 ...
                 new SpecificationTalent { TalentName = "Elemental Mastery", ColumnIndex = 1, RowIndex = 6, TalentIconId = icons.First(i => i.FileName == "spell_nature_wispheal").Id,
                    TalentRanks = new List<TalentRank> {
